document.addEventListener('DOMContentLoaded', function () {
    ...
    const animateCounters = (entries, observer) => {
        entries.forEach(entry => {
            if (entry.isIntersecting) {
                const counters = entry.target.querySelectorAll('.stat-number[data-animate="true"]');
    ...
    const proficiencyObserver = new IntersectionObserver(animateProficiencyBars, { threshold: 0.8 });
